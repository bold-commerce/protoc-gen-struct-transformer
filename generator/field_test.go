...
var _ = Describe("Field", func() {
	...
	Describe("ProcessSubMessages", func() {
		...
		DescribeTable("check result",
			func(fdp *descriptor.FieldDescriptorProto, pname, gname, pbType string, mo MessageOption, version int32, expected *Field) {
				fConf := FileConfig{Version: version}
				got, err := processSubMessage(nil, fdp, pname, gname, pbType, mo, goStruct, false, fConf)
			...
			// Version 1 tests
			Entry("Int64 - V1", &descriptor.FieldDescriptorProto{Name: &protoField}, protoField, goField, "int64", mo, v1, &Field{
				Name:           "StringField",
			...
			Entry("With messageOption and empty oneof - V1", &descriptor.FieldDescriptorProto{Name: &protoField}, protoField, goField, "int64", mo, v1, &Field{
				Name:           "StringField",
				ProtoName:      "ProtoField",
				ProtoType:      "Pb",
				ProtoToGoType:  "PbToMoTarget",
			...
			Entry("With messageOption and non-empty oneof - V1", &descriptor.FieldDescriptorProto{Name: &protoField}, protoField, goField, "int64", moWithOneOf, v1, &Field{
				Name:           "StringField",
				ProtoName:      "ProtoField",
				ProtoType:      "int64",
			...
			Entry("With messageOption, empty oneof, and fqdn type name - V1",
				...
				protoField, goField, "full.type", moWithOneOf, v1,
				&Field{
					Name:           "StringField",
					ProtoName:      "ProtoField",
					ProtoType:      "Type",
			...
			Entry("Repeated field - V1",
				...
				protoField, goField, "string", mo, v1,
				&Field{
					Name:           "StringField",
					ProtoName:      "ProtoField",
					ProtoType:      "Pb",
			...
			// Version 2 tests
			Entry("Int64 - V2", &descriptor.FieldDescriptorProto{Name: &protoField}, protoField, goField, "int64", mo, v2, &Field{
				Name:           "StringField",
				ProtoName:      "ProtoField",
				ProtoType:      "Pb",
				ProtoToGoType:  "PbToMoTarget",
			...
			Entry("With messageOption and empty oneof - V2", &descriptor.FieldDescriptorProto{Name: &protoField}, protoField, goField, "int64", mo, v2, &Field{
				Name:           "StringField",
				ProtoName:      "ProtoField",
				ProtoType:      "Pb",
				ProtoToGoType:  "PbToMoTarget",
			...
			Entry("Repeated field - V2",
				...
				protoField, goField, "string", mo, v2,
				&Field{
					Name:           "StringField",
					ProtoName:      "ProtoField",
					ProtoType:      "Pb",
